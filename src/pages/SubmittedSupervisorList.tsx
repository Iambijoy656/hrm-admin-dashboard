...
import SelectSuperVisorModal from '../components/Modal/SelectSuperVisorModal';

const SubmittedSupervisorList = () => {
    ...
    // const modal = document.getElementById('supervisor_selector_modal') as HTMLDialogElement | null;
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Submitted Supervisor List" />
...
export default SubmittedSupervisorList;