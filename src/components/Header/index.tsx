        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          <ul className="flex items-center gap-2 2xsm:gap-4">
            ...
            {user && Object.keys(user).length == 0 && <>
              ...
              <Link
                to={'/auth/signup'}
                className="flex justify-center rounded bg-graydark py-2 px-6 font-medium text-gray hover:bg-opacity-90"
                type="submit"
              >
                Registration
              </Link></>}
            ...
            {user && Object.keys(user).length > 0 && <DropdownNotification />}
            {/* <!-- Notification Menu Area --> */}

            {/* <!-- Chat Notification Area --> */}
            {user && Object.keys(user).length > 0 && <DropdownMessage />}
            {/* <!-- Chat Notification Area --> */}
          </ul>

          {/* <!-- User Area --> */}
          {user && Object.keys(user).length > 0 && <DropdownUser />}
